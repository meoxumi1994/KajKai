export default {
        ...
        [
            {
                ...
                event: 'COMMENT.FirstLayerCommentUpdated',
                fComment: {
                    fCommentId: '',
                    status:''
                }
    ...
    notification: {
        pub: [{
            ...
            event: 'FOLLOW.RemoveUserFollow',
            follow: {
                followerId: '',
                followeeId: ''
            }
        },{
            event: 'FOLLOW.AddUserFollow',
            follow: {
                followerId: '',
                followeeId: ''
            }
    ...
    interest: {
        pub: [{
            ...
            event: 'INTEREST.RemoveInterest',
            interest: {
                id: ''
            }
        },{
            event: 'INTEREST.NotifyNewStoreCreated',
            interest: {
                store: {
                    storeId: '',
                    storeName: '',
