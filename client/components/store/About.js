...
const About = ({ category, firstCategory, secondCategory, urlname, phone, storename, numfollow, numlike,  address, position,
    ...
    TOTAL_LIKE, TOTAL_COMMENT, TOTAL_REPLY_COMMENT, TOTAL_FOLLOW, CREATE_TIME, LAST_TIME }) => {
    return(
        <div>
            <div style={{
                borderRadius: 4,
                ...
                <hr style={{ margin: 0, padding: 0, borderColor: '#E9EbEE'}}/>
                <AboutCell kind="category" title={CATEGORY} value={firstCategory + " . " + secondCategory + " . " + category}/>
                <hr style={{ margin: 0, padding: 0, borderColor: '#E9EbEE'}}/>
