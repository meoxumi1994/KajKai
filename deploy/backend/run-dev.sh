...
zip ../../deploy/backend/dev/build/micro-chat.zip es6.js &&

cd ../micro-comment && webpack &&
zip ../../deploy/backend/dev/build/micro-comment.zip es6.js &&

cd ../micro-notification && webpack &&
zip ../../deploy/backend/dev/build/micro-notification.zip es6.js &&

cd ../micro-search && webpack &&
zip ../../deploy/backend/dev/build/micro-search.zip es6.js &&

cd ../micro-store && webpack &&
zip ../../deploy/backend/dev/build/micro-store.zip es6.js &&

cd ../micro-user && webpack &&
zip ../../deploy/backend/dev/build/micro-user.zip es6.js &&

cd ../../query/view-chat && webpack &&
zip ../../deploy/backend/dev/build/view-chat.zip es6.js &&

cd ../view-post && webpack &&
zip ../../deploy/backend/dev/build/view-post.zip es6.js &&

cd ../view-store && webpack &&
zip ../../deploy/backend/dev/build/view-store.zip es6.js &&

cd ../view-user && webpack &&
zip ../../deploy/backend/dev/build/view-user.zip es6.js &&
